...
Please feel free to reach me out for discussion or potential collaborations!


Publications
======

<div class="publication-item" style="display: flex; align-items: flex-start; gap: 20px; margin-bottom: 32px; flex-wrap: wrap;">
  <div style="flex: 1 1 calc(72% - 10px); min-width: 260px;">
    <h3 style="margin-top: 0;">Exploring Data-Free LoRA Transferability for Video Diffusion Models</h3>
  ...
  <div style="flex: 0 1 calc(28% - 10px); min-width: 160px;">
    <img src="/images/casa.png" alt="CASA method overview" style="width: 100%; height: auto; border-radius: 4px;">
  </div>
</div>

<div class="publication-item" style="display: flex; align-items: flex-start; gap: 20px; margin-bottom: 32px; flex-wrap: wrap;">
  <div style="flex: 1 1 calc(72% - 10px); min-width: 260px;">
    <h3 style="margin-top: 0;">Handling Imbalanced Pseudolabels for Vision-Language Models with Concept Alignment and Confusion-Aware Calibrated Margin</h3>
  ...
  <div style="flex: 0 1 calc(28% - 10px); min-width: 160px;">
    <img src="/images/CAP.png" alt="CAP method overview" style="width: 100%; height: auto; border-radius: 4px;">
  </div>
</div>
